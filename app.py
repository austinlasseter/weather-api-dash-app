...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
        ...
        html.Div([
            ...
            dcc.Input(id='latitude_input', type='number', debounce=True, min=-90, max=90, step=1, value=dc_latitude, placeholder=dc_latitude, style={'marginLeft':'10px'}),
            html.H3(id='lon-div', children='Longitude:'),
            dcc.Input(id='longitude_input', type='number', debounce=True, min=-180, max=180, step=1, value=dc_longitude, placeholder=dc_longitude, style={'marginLeft':'10px'}),
